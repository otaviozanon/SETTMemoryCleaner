    ...
    public class Language
    {
        ...
        public string DisplayEnglishName
        {
            get
            {
                switch (Name)
                {
                    case Constants.WinAPI.Locale.Name.PortugueseBrazil:
                        return "Portuguese";

                    case Constants.WinAPI.Locale.Name.PortuguesePortugal:
                        return "Portuguese";

                    case Constants.WinAPI.Locale.Name.SimplifiedChinese:
                        return "Chinese (S)";

                    case Constants.WinAPI.Locale.Name.TraditionalChinese:
                        return "Chinese (T)";
