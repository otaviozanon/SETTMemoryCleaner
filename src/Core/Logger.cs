    ...
    public static class Logger
    {
        ...
        public static void EnableConsoleOutput()
        {
            try
            {
                ...
                if (NativeMethods.AttachConsole(Constants.WinAPI.Console.AttachParentProcess))
                {
                    var stdHandle = NativeMethods.GetStdHandle(Constants.WinAPI.Console.StdOutputHandle);
        ...
        public static void Log(Log log)
        {
            ...
            {
                Event(string.Format(Localizer.Culture, Localizer.Strings.ErrorCanNotSaveLog, log != null ? log.Message : "NULL", e.GetMessage()), EventLogEntryType.Error);
            }
        }
