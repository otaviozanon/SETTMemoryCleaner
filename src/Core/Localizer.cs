...
namespace SETTMemoryCleaner
{
    ...
    public static class Localizer
    {
        ...
        static Localizer()
        {
            ...
            {
                Culture = new CultureInfo(Constants.WinAPI.Locale.Name.English);
            }
        ...
        public static Language Language
        {
            ...
            set
            {
                ...
                {
                    Settings.Language = Constants.WinAPI.Locale.Name.English;
                    Settings.Save();
        ...
        public static List<Language> Languages
        {
            get
            {
                ...
                catch (Exception e)
                {
                    ...
                    return new List<Language> { new Language(new CultureInfo(Constants.WinAPI.Locale.Name.English)) };
                }
            }
        }
        ...
        /// </summary>
        public static Localization Strings { get; private set; }
