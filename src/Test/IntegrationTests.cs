            ...
            public void Localization_SwitchLanguage_UpdatesAllStrings()
            {
                ...
                try
                {
                    ...
                    foreach (var language in availableLanguages.Take(Math.Min(3, availableLanguages.Count)))
                    {
                        ...
                        Assert.IsNotNull(Localizer.Strings);
                        Assert.IsFalse(string.IsNullOrEmpty(Localizer.Strings.About));
                        Assert.IsFalse(string.IsNullOrEmpty(Localizer.Strings.Close));
                        Assert.IsFalse(string.IsNullOrEmpty(Localizer.Strings.Settings));
                    }
                }
                finally
                {
