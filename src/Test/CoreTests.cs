...
namespace SETTMemoryCleaner.Test
{
    ...
    public static class CoreTests
    {
        ...
        public class ConstantsTests
        {
            ...
            {
                Assert.AreEqual(-1, Constants.WinAPI.Console.AttachParentProcess);
            }

            [Test]
            public void Windows_Console_StdOutputHandle_IsNegativeEleven()
            {
                Assert.AreEqual(-11, Constants.WinAPI.Console.StdOutputHandle);
            }

            [Test]
            public void Windows_Privilege_SeDebugName_IsCorrect()
            {
                Assert.AreEqual("SeDebugPrivilege", Constants.WinAPI.Privilege.SeDebugName);
            }

            [Test]
            public void Windows_Privilege_SeIncreaseQuotaName_IsCorrect()
            {
                Assert.AreEqual("SeIncreaseQuotaPrivilege", Constants.WinAPI.Privilege.SeIncreaseQuotaName);
            }

            [Test]
            public void Windows_PrivilegeAttribute_Enabled_IsTwo()
            {
                Assert.AreEqual(2, Constants.WinAPI.PrivilegeAttribute.Enabled);
            }

            [Test]
            public void Windows_SystemErrorCode_ErrorAccessDenied_IsFive()
            {
                Assert.AreEqual(5, Constants.WinAPI.SystemErrorCode.ErrorAccessDenied);
            }

            [Test]
            public void Windows_SystemErrorCode_ErrorSuccess_IsZero()
            {
                Assert.AreEqual(0, Constants.WinAPI.SystemErrorCode.ErrorSuccess);
            }
        }
        ...
        public class ExtensionMethodsTests
        {
            ...
            public void GetKeyValue_WithNo_ReturnsCorrectKeyValue()
            {
                ...
                Assert.AreEqual(Localizer.Strings.No, result.Key);
            ...
            public void GetKeyValue_WithYes_ReturnsCorrectKeyValue()
            {
                ...
                Assert.AreEqual(Localizer.Strings.Yes, result.Key);
            ...
            public void GetString_WithLowMemoryReason_ReturnsCorrectString()
            {
                ...
                Assert.AreEqual(Localizer.Strings.LowMemory, result);
            }
            ...
            public void GetString_WithManualReason_ReturnsCorrectString()
            {
                ...
                Assert.AreEqual(Localizer.Strings.Manual, result);
            }
            ...
            public void GetString_WithScheduleReason_ReturnsCorrectString()
            {
                ...
                Assert.AreEqual(Localizer.Strings.Schedule, result);
            }
        ...
        public class LocalizerTests
        {
            ...
            public void Language_CanBeSet()
            {
                ...
                try
                {
                    Localizer.Language = Localizer.Languages.Find(language => language.Name == Constants.WinAPI.Locale.Name.English);
            ...
            {
                var localization = Localizer.Strings;
